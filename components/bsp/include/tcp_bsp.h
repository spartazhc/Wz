...
#define GATEWAY_SSID            "115_X11"         //账号
#define GATEWAY_PAS             "19980527"       //密码
#define TCP_SERVER_ADRESS       "121.42.180.30"     //作为client，要连接TCP服务器地址
#define TCP_PORT                8181               //统一的端口号，包括TCP客户端或者服务端
